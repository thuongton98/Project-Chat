...
if(ok!==''){
    return(
        ...
        <form onSubmit={(e)=>submitchat(e)}>
          <input onChange={(e)=>setmess(e.target.value)} type="text" placeholder="type ....." />
          <input ref={ref=>messref=ref} onClick={(e)=>submitchat(e)} className="submit-chat" type="submit" defaultValue="submit" />
        </form>
      </section>
    )
}
