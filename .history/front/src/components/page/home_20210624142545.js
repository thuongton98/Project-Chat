    ...
    if(room!==''){
       ...
       {showallmess(messroom)}
        ...
        <form onSubmit={(e)=>submitchatroom(e,room)}>
          ...
          <input  onClick={(e)=>submitchatroom(e,room)} className="submit-chat" type="submit" defaultValue="Send" />
        </form>
      </section>
      <footer>
   ...
   if(user.length>0){
       ...
       {showallmess(allmess)}
        <form onSubmit={(e)=>submitchat(e,'global')}>
          <input ref={ref=>messref=ref} onChange={(e)=>setmess(e.target.value)} type="text" placeholder="type ....." />
          <input  onClick={(e)=>submitchat(e,'global')} className="submit-chat" type="submit" defaultValue="Send" />
        </form>
      </section>
      <footer>
      <div className='copyright'>
