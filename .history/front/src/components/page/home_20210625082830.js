...
function Home(){
    ...
    function mouse(e){
        if(e.target!==style){
            style.style.backgroundColor = '#42bcf5'
            style.style.borderColor = '#42bcf5'
            ...
            return(
               <div className='online-i'>
                ...
                <div className="online">
                    ...
                    <div onClick={(e)=>{global(e)}}>Global</div>
                    {e.map((value,index)=>{
                       if(value.name!==username){
                        return(
                            <div className='online-ii' onClick={(e)=>showmess(value.name, z,e)} key={index}>{value.name}</div>
                        )
                       }else{
                           return(
                            <span  key={index}></span>
