...
function Home(){
    ...
    function hoverchinh(e){
        if(hoverok!==''){
            hoverok.target.style.backgroundColor = '#42bcf5'
            hoverok.target.style.borderColor = '#42bcf5'
            hoverok.target.style.color = '#fff'
        }
    }
    function mouse(e){
        if(style!==''){
            ...
            return(
               <div className='online-i'>
                ...
                <div className="online">
                    ...
                    <div className='online-ii' onMouseOver={(e)=>hover(e)} onClick={(e)=>{global(e)}}>Global</div>
                    {e.map((value,index)=>{
