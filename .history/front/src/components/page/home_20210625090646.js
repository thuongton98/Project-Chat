...
function Home(){
    ...
    function mouse(e){
        ...
        var od = document.querySelector('.online-default')
        ...
        if(od!==e.target){
            ...
            for(let i=0;i<x.length;i++){
                if(od !== x[i]){
                    od.style.backgroundColor = '#fff'
                    od.style.borderColor = 'red'
                    od.style.color = 'black'
                   
                }
            }
        }else{
            od.style.backgroundColor = '#42bcf5'
            od.style.borderColor = '#42bcf5'
            od.style.color = '#fff'
        }
        if(style!==''){
            if(e.target!==style){
            ...
            return(
               <div className='online-i'>
                ...
                <div className="online">
                    ...
                    <div className='online-default' onClick={(e)=>{global(e)}}>Global</div>
                    {e.map((value,index)=>{
