            ...
            return(
               <div className='online-i'>
                ...
                <div className="online">
                    ...
                    {e.map((value,index)=>{
                      if(messroom.length>0){
                       const find = messroom.filter(function(value){
                            if(value.seen[1]!==undefined){
                                return value.seen[0]===username || value.seen[1]===username
                            }
                        })
                        console.log(find)
