...
function addVideoStream(video, stream) {
   ...
   if(video!==null){
    ...
    return(
        ...
        <h1>test video</h1>
        <video className={'video '+classvideo2} autoPlay playsInline muted ref={ref=>videoz=ref} ></video>
        <video className={'video '+classvideo1} autoPlay playsInline muted ref={ref=>videozz=ref}></video>
      </section>
    )
}
