...
function addVideoStream(video, stream) {
   ...
   if(video!==null){
    ...
    return(
        ...
        <h1>test video</h1>
        <button className='call' ref={ref=>callz=ref} onClick={(e)=>socket.emit('call',ROOM_ID)}>call</button>
        <button className='call none' ref={ref=>acceptz=ref} onClick={(e)=>socket.emit('accept',ROOM_ID)}>acept</button>
